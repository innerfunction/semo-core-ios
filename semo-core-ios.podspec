#
#  Be sure to run `pod spec lint semo-core-ios.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
    Core functionality for the Semo app platform.
    This library provides:
    * Internal URI space;
    * Inversion of Control container functionality;
    * Actions/events through target containers;
    * Basic UI views;
    * Supporting utility functions.
                 DESC

  s.homepage     = "https://github.com/innerfunction/semo-core-ios"
